...
test.describe('Domain Management', () => {
    ...
    test('should display domains for current tab (requires extension ID)', async ({page, mockServer}) => {
    ...
    test('should add domain to allowlist (requires extension ID)', async ({page, mockServer}) => {
        const extensionId = process.env.EXTENSION_ID;
    ...
    test('should add domain to denylist (requires extension ID)', async ({page, mockServer}) => {
        const extensionId = process.env.EXTENSION_ID;
    ...
    test('should show domain status indicators (requires extension ID)', async ({page, mockServer}) => {
        const extensionId = process.env.EXTENSION_ID;
        ...
        mockServer.setHandler('GET', '/api/search/allowed.example.com', (_req, res) => {
        ...
        await expect(domainRow.locator('.status-indicator.allowlist')).toBeVisible();
    });

    test('should filter first-party vs third-party domains (requires extension ID)', async ({page, mockServer}) => {
        const extensionId = process.env.EXTENSION_ID;
    ...
    test('should search domains (requires extension ID)', async ({page, mockServer}) => {
        const extensionId = process.env.EXTENSION_ID;
    ...
    test('should handle domain action errors (requires extension ID)', async ({page, mockServer}) => {
        const extensionId = process.env.EXTENSION_ID;
...
test.describe('Domain Management API Tests', () => {
    test('should successfully add domain to allowlist', async ({page, mockServer}) => {
        await page.goto('https://example.com');
    ...
    test('should successfully add domain to denylist', async ({page, mockServer}) => {
        await page.goto('https://example.com');
    ...
    test('should search and find blocked domains', async ({page, mockServer}) => {
        await page.goto('https://example.com');
    ...
    test('should search and find allowed domains', async ({page, mockServer}) => {
        await page.goto('https://example.com');
...
test.describe('Query Log', () => {
    ...
    test('should display query log (requires extension ID)', async ({page, mockServer}) => {
        const extensionId = process.env.EXTENSION_ID;
    ...
    test('should show blocked queries with indicator (requires extension ID)', async ({page, mockServer}) => {
        const extensionId = process.env.EXTENSION_ID;
    ...
    test('should filter blocked queries (requires extension ID)', async ({page, mockServer}) => {
        const extensionId = process.env.EXTENSION_ID;
    ...
    test('should refresh query log (requires extension ID)', async ({page, mockServer}) => {
        const extensionId = process.env.EXTENSION_ID;
...
test.describe('Query Log API Tests', () => {
    ...
    test('should have both blocked and allowed queries', async ({page, mockServer}) => {
        await page.goto('https://example.com');
