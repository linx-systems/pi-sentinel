...
test.describe('PiSentinel Extension', () => {
    ...
    test('should show options page (requires extension ID)', async ({page, mockServer}) => {
        const extensionId = process.env.EXTENSION_ID;
        ...
        await expect(page.locator('text=Pi-hole Configuration')).toBeVisible({timeout: 5000});
    });

    test('should authenticate with Pi-hole (requires extension ID)', async ({page, mockServer}) => {
        const extensionId = process.env.EXTENSION_ID;
    ...
    test('should display statistics in popup (requires extension ID)', async ({page, mockServer}) => {
        const extensionId = process.env.EXTENSION_ID;
    ...
    test('should toggle blocking status (requires extension ID)', async ({page, mockServer}) => {
        const extensionId = process.env.EXTENSION_ID;
